...
from edsnlp.core.component import TorchComponent, BatchInput
from edsnlp.layers.text_cnn import NormalizationPlacement, TextCNN
...
class TextCNNEncoder(TorchComponent[WordEmbeddingBatchOutput, BatchInput]):
    ...
    def forward(self, batch: BatchInput) -> WordEmbeddingBatchOutput:
        ...
        """
        embedding_results = self.embedding(batch)
