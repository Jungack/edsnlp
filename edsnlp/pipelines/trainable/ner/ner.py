...
from edsnlp.layers.crf import MultiLabelBIOULDecoder
from edsnlp.utils.filter import filter_spans
from ..embeddings.typing import WordEmbeddingBatchOutput, BatchInput
...
@registry.misc.register("span-getter")
...
class NER(TorchComponent[NERBatchOutput, NERBatchInput]):
    def __init__(
        self,
        nlp,
        name: str,
    ...
    def score(self, examples: Sequence[Example]):
        return nested_ner_scorer(examples, labels=self.labels, spans_labels={})
